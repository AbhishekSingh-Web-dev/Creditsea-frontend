...
export default function Page3() {
  useEffect(() => {
    logEvent("pageVisit", "page3");
    const enterTime = Date.now();
    return () => {
      const duration = (Date.now() - enterTime) / 1000;
      logEvent("timeOnPage", "page3", { seconds: duration });
    };
  }, []);

  const handleClick = () => {
    logEvent("buttonClick", "page3", { button: "click  button" });
  };

  return (
    <div className="p-4">
      <h1 className="text-2xl">Welcome to Page3</h1>
